// include plugin contextmenu for editor
;zjs.require('editor', function(){
	...
	zjs.extend(zjs.moduleEditorPlugins, {
		contextmenu: function(option, editorOption){
			// neu nhu option cua plugin bat len thi moi cho phep su dung contextmenu
			if('contextmenu' in option && !option.contextmenu){
	...
	// done
	zjs.required('editor.contextmenu');
});