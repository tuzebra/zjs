...
function(){m(this,n(this,a,d),a)});if(a.autoCheckWhenInput)c.on("input, ui:autosuggestion:input",function(){m(this,n(this,a,d),a)});if(c.hasClass(a.radiogroupClass))c.on("click","input[type=radio]",function(){m(c,n(c,a,d),a)});if(c.hasClass(a.checkboxClass))if(c.is("input"))c.on("click",function(){m(c,n(c,a,d),a)});else c.on("click","input[type=checkbox]",function(){m(c,n(c,a,d),a)});c.parent().addClass("z-form-field")}});e.enablehook(b)};h();e.hook({after_insertDOM:function(a){h()}});var k=!1;d.on("submit",
function(a){t(b,a)?(this.removeClass("zvalidation-invalid"),k?(k=!1,a.preventDefault()):this.trigger("form:validation:success",{},function(b){b.isDefaultPrevented&&a.preventDefault()})):this.addClass("zvalidation-invalid").trigger("form:validation:failed",{status:d.getData("zjsmoduleformvalidationpassStatus")})});e(window).on("keydown",function(a){13==a.getKeyCode()&&(a=e(a.target()).findUp("form"),0<a.count()&&(a=a.getData("zjsmoduleformvalidationoption",!1))&&a.preventPressEnterToSubmit&&(k=!0))});
(function(){d.find(".autofocus").focus()}).delay(100)}},t=function(b,c){var d=e(b),a=d.getData("zjsmoduleformvalidationoption");if(a){"moduleEditorOption"in e&&d.find("textarea").editorSave();var g=!0,h,k={};d.find("input,textarea,."+a.radiogroupClass+",."+a.checkboxClass+",."+a.customInputClass).eachElement(function(b){var c=e(b);if((c.is(q+", ."+a.customInputClass)||c.getData("zmoduleautosuggestionwrapel",!1))&&!c.hasClass("zui-autosuggestion-input")&&!c.hasClass("zui-datepicker-input")&&(m(b,h=
n(b,a,d),a),b=c.getAttr("name",""),""!=b&&(k[b]=h),!h.pass&&(g=!1,a.onlyone)))return!1});d.setData("zjsmoduleformvalidationpassStatus",k);if(!g){try{"undefined"!=typeof c&&c&&c.preventDefault()}catch(l){}var f=d.find("."+a.errorClass).item(0);f.is("input")||f.is("textarea")?f.focus():f.isAutosuggestion()?f.autosuggestionFocus():f.hasClass("radiogroup")&&"moduleTransition"in e&&e(document.body).playTransition("scrollTop",f.getAbsoluteTop()-100,{time:800});return!1}return!0}},w=function(b){b=e(b);var c=
b.getData("zjsmoduleformvalidationoption",!1);c&&b.find("input,textarea,."+c.checkboxClass).eachElement(function(b){b=e(b);var a=b.getData("zjsmoduleformvalidationtipel",!1);a&&(a.hide(),b.removeClass(c.errorClass),(a=b.getData("zmoduleuidatepickerwrapel",!1))&&a.removeClass(c.errorClass),(a=b.getData("zjsmoduleimagepickerwrapel",!1))&&a.removeClass(c.errorClass),(b=b.getData("zmoduleautosuggestionwrapel",!1))&&b.removeClass(c.errorClass))})},m=function(b,c,d){b=e(b);if(c.pass){b.removeClass(d.errorClass);
var a=b.getData("zjsmoduleformvalidationtipel");a&&a.hide();(c=b.getData("zmoduleuidatepickerwrapel",!1))&&c.removeClass(d.errorClass);(c=b.getData("zjsmoduleimagepickerwrapel",!1))&&c.removeClass(d.errorClass);(b=b.getData("zmoduleautosuggestionwrapel",!1))&&b.removeClass(d.errorClass)}else{b.addClass(d.errorClass);if(a=b.getData("zjsmoduleformvalidationtipel")){var g=d.tips[c.type];""!=b.getAttr("data-tip-"+c.type,"")&&(g=b.getAttr("data-tip-"+c.type,""));a.show().find(".text").setInnerHTML(g)}(c=
b.getData("zmoduleuidatepickerwrapel",!1))&&c.addClass(d.errorClass);(c=b.getData("zjsmoduleimagepickerwrapel",!1))&&c.addClass(d.errorClass);(b=b.getData("zmoduleautosuggestionwrapel",!1))&&b.addClass(d.errorClass)}},n=function(b,c,d){var a=e(b);if(a.hasClass(c.preventClass))return{pass:!0};a.getAttr("id","").trim().toLowerCase();var g=a.getAttr("name","").trim().toLowerCase(),h=a.getAttr("type","").trim().toLowerCase(),k=a.getAttr("class","").trim().toLowerCase(),f=a.getValue("").trim();a.hasClass(c.radiogroupClass)&&
(f=a.find("input[type=radio]:checked").getValue("").trim());a.hasClass(c.checkboxClass)&&(a.is("input")?a.is(":checked")||(f=""):f=a.find("input[type=checkbox]:checked").getValue("").trim());a.hasClass(c.customInputClass)&&(f=a.getAttr("data-value",""));a.getData("zmoduleuidatepickerwrapel",!1)&&(f=a.getValue());a.getData("zjsmoduleimagepickerwrapel",!1)&&(f=(f=a.getValue())?parseInt(f):0,0>=f&&(f=""));if(""==f&&(0<=k.indexOf("required")||""!=a.getAttr("data-tip-required","")))return{pass:!1,type:"required"};
if(""!=f){var l="";if(0<=g.indexOf("email")||0<=k.indexOf("email")||""!=a.getAttr("data-tip-email","")||"email"==h)l="email";else if(0<=g.indexOf("url")||0<=k.indexOf("url")||""!=a.getAttr("data-tip-url",""))l="url";else if(0<=g.indexOf("phonenumber")||0<=k.indexOf("phonenumber")||""!=a.getAttr("data-tip-phonenumber",""))l="phonenumber";else if(0<=g.indexOf("number")||0<=k.indexOf("number")||""!=a.getAttr("data-tip-number","")||"number"==h)l="number";else if(0<=g.indexOf("digits")||0<=k.indexOf("digits")||
""!=a.getAttr("data-tip-digits",""))l="digits";else if(0<=g.indexOf("date")||""!=a.getAttr("data-tip-date","")||"date"==h)l="date";if(""!=l&&!u[l](f,b))return{pass:!1,type:l}}if(""!=f){if(0<=g.indexOf("minlength")||0<=k.indexOf("minlength")||""!=a.getAttr("data-tip-minlength",""))l="minlength";if(""!=l&&!u[l](f,b))return{pass:!1,type:l}}if("password"==h&&(0<=g.indexOf("repassword")||0<=g.indexOf("pass[pass2]")||0<=k.indexOf("repassword")||""!=a.getAttr("data-tip-repassword",""))&&(g=d.find('input[type="password"]'),
1<g.count())){var m=-1;g.eachElement(function(b,c){a.isTheSame(b)&&(m=c)});if(1<=m&&a.getValue("")!=g.item(m-1).getValue())return{pass:!1,type:"repassword"}}d.trigger("form:validation:checking",{element:b,option:c},function(a){});return{pass:!0}},u={email:function(b,c){return/^((([a-z]|\d|[!#\$%&'\*\+\-\/=\?\^_`{\|}~]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])+(\.([a-z]|\d|[!#\$%&'\*\+\-\/=\?\^_`{\|}~]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])+)*)|((\x22)((((\x20|\x09)*(\x0d\x0a))?(\x20|\x09)+)?(([\x01-\x08\x0b\x0c\x0e-\x1f\x7f]|\x21|[\x23-\x5b]|[\x5d-\x7e]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])|(\\([\x01-\x09\x0b\x0c\x0d-\x7f]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF]))))*(((\x20|\x09)*(\x0d\x0a))?(\x20|\x09)+)?(\x22)))@((([a-z]|\d|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])|(([a-z]|\d|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])([a-z]|\d|-|\.|_|~|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])*([a-z]|\d|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])))\.)+(([a-z]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])|(([a-z]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])([a-z]|\d|-|\.|_|~|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])*([a-z]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])))$/i.test(b)},
