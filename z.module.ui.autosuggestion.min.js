...
function(){M()}.delay(100)))});zjs(document).on("click",function(a){a=zjs(a.target()).findUp(".zui-autosuggestion-wrap");if(0<a.count()&&(a=a.find(".zui-autosuggestion-panel-wrap"),0<a.count()&&a.item(0,!0)===n.item(0,!0)))return;(function(){n.addClass("zui-panel-hide")}).delay(1)});if(a.multichoice)u.on("click",".zui-autosuggestion-token",function(a){this.remove();A();""==b.getValue()&&(h.removeClass("zui-autosuggestion-with-token"),""==k&&(r="",l(m,x())));(function(){m.show().top(e.top()).left(e.left())}).delay(50)});
