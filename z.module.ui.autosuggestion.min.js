...
itemLinkFormat:"",itemhighlightclass:"highlight",defaultPanelHeight:0,selectLikeInput:!1,defaultSuggestionMoreText:"",suggestIconRightChoose:" <b>&rarr;</b> press Right to choose",suggestIconEnterChoose:" <sub><b>&crarr;</b></sub> press Return to choose",suggestIconEnterCreate:" <sub><b>&crarr;</b></sub> press Return to add this keyword"}});var P="oninput"in document.createElement("input"),O=function(b,f){var c=zjs(b),a=c.getData("zjsmoduleautosuggestionoption"),E=!1;if(a)c.setData("zjsmoduleautosuggestionoption",
zjs.extend(a,f)),E=!0;else{var G=!0,B=!1;a=zjs.clone(zjs.moduleUiAutosuggestionOption);var p=c.getAttr("data-option","");zjs.isString(p)&&""!=p.trim()&&(a=zjs.extend(a,p.jsonDecode()));c.removeAttr("data-option");a.sourceUrl||(p=c.getAttr("data-autocomplete-path",""),""!==p&&(a.sourceUrl=p));zjs.hook({after_setAttr:function(d,u,e){d===b&&"data-autocomplete-path"===u&&(d=c.getAttr("data-autocomplete-path",""),""==d?G=!1:(G=!0,a.sourceUrl=d,q.setDataSourceUrl(a.sourceUrl)))}});"undefined"!=typeof f&&
(a=zjs.extend(a,f));var H=c.getValue(""),r=!1;if(zjs.isString(a.source)||c.is("select"))r=zjs.isString(a.source)?zjs(a.source):c,0<r.count()?(B=c.is("select"),a.multichoice=!1,a.usedproperty="id.text",a.source={},r.find("option").eachElement(function(d,u){var e=zjs(d).getValue(),b=zjs(d).getInnerText();e!==a.noneValue&&(a.source[e]=b,0===u&&e!=a.noneValue&&c.setValue(e,!0),d.selected&&e!=a.noneValue&&(H=b,B?r.setValue(e,!0):c.setValue(b,!0)))}),r.hide(),B?a.selectLikeInput&&r.addClass("select-like-input"):
r.removeAttr("required").removeClass("required")):r=!1;B&&!a.selectLikeInput&&(a.focusshowsuggestion=!0);p=a.searchproperty;"id.text"==a.usedproperty&&(a.searchproperty="text",a.usedproperty="id",p="id.text");a.mentionmode&&(a.multichoice=!1);a.multichoice&&(a.multiline=!1);a.limit=parseInt(a.limit);isNaN(a.limit)&&(a.limit=0);a.defaultPanelHeight=parseInt(a.defaultPanelHeight);isNaN(a.defaultPanelHeight)&&(a.defaultPanelHeight=0);if(a.usedSearchRegExp&&zjs.isObject(a.usedSearchRegExp)){var v={used:/^(.+\(\d{1,}\))$/,
search:/^(.+)\s\(\d{1,}\)$/};a.usedSearchRegExp.used&&(zjs.isString(a.usedSearchRegExp.used)&&(a.usedSearchRegExp.used=new RegExp(a.usedSearchRegExp.used)),zjs.isRegExp(a.usedSearchRegExp.used)&&(v.used=a.usedSearchRegExp.used));a.usedSearchRegExp.search&&(zjs.isString(a.usedSearchRegExp.search)&&(a.usedSearchRegExp.search=new RegExp(a.usedSearchRegExp.search)),zjs.isRegExp(a.usedSearchRegExp.search)&&(v.search=a.usedSearchRegExp.search));a.usedSearchRegExp=v}c.setData("zjsmoduleautosuggestionoption",
...
a.multiline?h.find("input.zui-autosuggestion-input").remove():h.find("textarea.zui-autosuggestion-input").remove();c.setData("zmoduleautosuggestionwrapel",h);h.insertAfter(c);var x=h.find(".zui-autosuggestion-inputwrap"),l=h.find(".zui-autosuggestion-placeholder"),e=h.find("input.zui-autosuggestion-input,textarea.zui-autosuggestion-input"),m=h.find(".zui-autosuggestion-panel-wrap"),I=h.find(".zui-autosuggestion-panel-scroll"),w=h.find(".zui-autosuggestion-panel-content"),J=!1;e.setAttr("autocomplete",
Math.random().toString(36).replace(/[^a-z]+/g,"").substr(0,10));c.setData("zmoduleautosuggestionwrapinputel",x);c.setData("zjsmoduleautosuggestionnewinput",e.item(0,!0));a.multiline?(J=h.find(".zui-estimate-height"),h.addClass("multiline")):h.find(".zui-estimate-height-wrap").remove();a.suggestIconRightChoose&&l.setData("suggestIconRightChoose",a.suggestIconRightChoose);a.suggestIconEnterChoose&&l.setData("suggestIconEnterChoose",a.suggestIconEnterChoose);a.suggestIconEnterCreate&&l.setData("suggestIconEnterCreate",
a.suggestIconEnterCreate);if(!a.customcss){v=c.width();var Q=c.height();c.getStyle("margin-left",!0);c.getStyle("margin-right",!0);c.getStyle("margin-top",!0);c.getStyle("margin-bottom",!0);var O=c.getStyle("padding-left",!0),ba=c.getStyle("padding-right",!0),ca=c.getStyle("padding-top",!0),da=c.getStyle("padding-bottom",!0),ea=c.getStyle("border-left-width",!0),fa=c.getStyle("border-right-width",!0),ha=c.getStyle("border-top-width",!0),ia=c.getStyle("border-bottom",!0),ja=c.getStyle("font");"content-box"==
c.getStyle("box-sizing")&&(v-=O+ba+ea+fa,Q-=ca+da+ha+ia);x.copyStyleFrom(c);x.setStyle({position:"relative",cursor:"text",width:v,height:Q,"-webkit-text-fill-color":"initial"});e.setStyle({top:l.top(),font:ja,width:v})}var K=!1;a.multichoice?(h.addClass("zui-autosuggestion-multi-wrap"),K=h.find(".zui-autosuggestion-input-test").setStyle({margin:e.getStyle("margin"),padding:e.getStyle("padding"),font:e.getStyle("font"),border:e.getStyle("border")})):h.find(".zui-autosuggestion-input-test-wrap").remove();
m.height(a.panelmaxheight);I.makeScrollbar({bounce:!1,usecss:!1,usekey:!1,customCssClass:"zui-autosuggestion-panel",autoUseDefaultWithMobile:!0});m.addClass("zui-panel-hide");var R=function(d){d=Math.min(d,a.panelmaxheight);m.height(d);I.scrollHeight(d).refreshScroll().scrollToTop();m.find(".zui-scrollbar").top(0)},S="",y=function(){return c.getAttr("data-placeholder",c.getAttr("placeholder",""))},n=0,F=0,g="",t="",C=0,T="";v=y();a.labelPlaceholder&&""!==v&&(zjs("<span>").addClass("placeholder").html(v).insertAfter(x),
x.addClass("label-placeholder"));k(l,y());c.hide();""!==H&&(e.setValue(g=H,!0),k(l,""),h.addClass("has-value"));var q=new zjs.dictionary(a.source,p);a.cacheResponse||q.setCacheResponse(!1);""!=a.sourceUrl&&q.setDataSourceUrl(a.sourceUrl);""!=a.initSourceUrl&&(q.setDataSourceUrl(a.initSourceUrl),""===a.sourceUrl&&q.useCacheDataSource(!0),q.getDataFromDataSource());""!=a.sourceDataStructure&&q.setDataSourceDataStructure(a.sourceDataStructure);0<a.limit&&q.setDefaultSearchResultLimit(a.limit);a.searchMatchStartWith&&
q.setSearchMatchStartWith(!0);c.setData("zjsmoduleautosuggestiondictionary",q);var U=function(d){var c=null,e=null,b=d.match(a.usedSearchRegExp.used);b&&2<=b.length&&b[1]&&(c=b[1]);(b=d.match(a.usedSearchRegExp.search))&&2<=b.length&&b[1]&&(e=b[1]);return c&&e?{used:c,search:e}:!1},V=function(){B&&(""===c.getValue()?(g="",k(l,""),e.setValue("",!0),h.removeClass("has-value")):h.addClass("has-value"));m.addClass("zui-panel-hide");c.trigger("ui:autosuggestion:blur")},D=function(d,u){E&&(a=c.getData("zjsmoduleautosuggestionoption"),
