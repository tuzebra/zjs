...
itemhighlightclass:"highlight",defaultPanelHeight:0}});var P="oninput"in document.createElement("input"),O=function(d,g){var b=zjs(d),a=b.getData("zjsmoduleautosuggestionoption"),E=!1;if(a)b.setData("zjsmoduleautosuggestionoption",zjs.extend(a,g)),E=!0;else{var G=!0,B=!1;a=zjs.clone(zjs.moduleUiAutosuggestionOption);var w=b.getAttr("data-option","");zjs.isString(w)&&""!=w.trim()&&(a=zjs.extend(a,w.jsonDecode()));b.removeAttr("data-option");a.sourceUrl||(w=b.getAttr("data-autocomplete-path",""),""!==
w&&(a.sourceUrl=w));zjs.hook({after_setAttr:function(c,f,e){c===d&&"data-autocomplete-path"===f&&(c=b.getAttr("data-autocomplete-path",""),""==c?G=!1:(G=!0,a.sourceUrl=c,t.setDataSourceUrl(a.sourceUrl)))}});"undefined"!=typeof g&&(a=zjs.extend(a,g));var H=b.getValue(""),r=!1;if(zjs.isString(a.source)||b.is("select"))r=zjs.isString(a.source)?zjs(a.source):b,0<r.count()?(B=b.is("select"),a.multichoice=!1,a.usedproperty="id.text",a.source={},r.find("option").eachElement(function(c,f){var e=zjs(c).getValue(),
d=zjs(c).getInnerText();e!==a.noneValue&&(a.source[e]=d,0===f&&e!=a.noneValue&&b.setValue(e),c.selected&&e!=a.noneValue&&(H=d,B?r.setValue(e):b.setValue(d)))}),r.hide(),B||r.removeAttr("required").removeClass("required")):r=!1;B&&(a.focusshowsuggestion=!0);w=a.searchproperty;"id.text"==a.usedproperty&&(a.searchproperty="text",a.usedproperty="id",w="id.text");a.mentionmode&&(a.multichoice=!1);a.multichoice&&(a.multiline=!1);a.limit=parseInt(a.limit);isNaN(a.limit)&&(a.limit=0);a.defaultPanelHeight=
parseInt(a.defaultPanelHeight);isNaN(a.defaultPanelHeight)&&(a.defaultPanelHeight=0);b.setData("zjsmoduleautosuggestionoption",a);var h=zjs('<div class="zui-autosuggestion-wrap"><div class="zui-autosuggestion-inputwrap"><div class="zui-autosuggestion-placeholder"></div><input class="zui-autosuggestion-input" autocomplete="off" /><textarea class="zui-autosuggestion-input" autocomplete="off"></textarea><div class="zui-autosuggestion-input-test-wrap"><div class="zui-autosuggestion-input-test"></div></div><div class="zui-estimate-height-wrap"><div class="zui-autosuggestion-input zui-estimate-height"></div></div></div><div class="zui-autosuggestion-panel-wrap zui-panel-hide"><div class="zui-autosuggestion-panel-scroll"><div class="zui-autosuggestion-panel-content"></div></div></div></div>');
...
b.getAttr("placeholder",""))},p=0,F=0,k="",q="",z=0,T="";C=x();a.labelPlaceholder&&""!==C&&(zjs("<span>").addClass("placeholder").html(C).insertAfter(u),u.addClass("label-placeholder"));l(m,x());b.hide();""!==H&&(e.setValue(k=H),l(m,""),h.addClass("has-value"));var t=new zjs.dictionary(a.source,w);a.cacheResponse||t.setCacheResponse(!1);""!=a.sourceUrl&&t.setDataSourceUrl(a.sourceUrl);""!=a.initSourceUrl&&(t.setDataSourceUrl(a.initSourceUrl),""===a.sourceUrl&&t.useCacheDataSource(!0),t.getDataFromDataSource());
""!=a.sourceDataStructure&&t.setDataSourceDataStructure(a.sourceDataStructure);0<a.limit&&t.setDefaultSearchResultLimit(a.limit);a.searchMatchStartWith&&t.setSearchMatchStartWith(!0);b.setData("zjsmoduleautosuggestiondictionary",t);var U=function(){B&&(""===b.getValue()?(k="",l(m,""),e.setValue(""),h.removeClass("has-value")):h.addClass("has-value"));b.trigger("ui:autosuggestion:blur")},D=function(c,f){E&&(a=b.getData("zjsmoduleautosuggestionoption"),E=!1);var d=c.getKeyCode();38==d||40==d?"keydown"==
f&&ia(c,d):37!=d&&(39==d||9==d?("keydown"==f&&ja(),9==d&&(n.addClass("zui-panel-hide"),U())):13==d?a.multichoice?""!=e.getValue("")&&("keydown"==f&&V(),c.preventDefault()):(d=n.hasClass("zui-panel-hide"),"keydown"==f&&V(),a.multiline&&(c.preventDefault(),y(),d&&function(){b.findUp("form").submit()}.delay(1))):27==d?(n.hasClass("zui-panel-hide")||e.setValue(k),"text"===a.usedproperty||a.usedpropertytext?(b.setValue(k),""===k?l(m,x()):l(m,q="")):b.setValue(""),n.addClass("zui-panel-hide"),v.find(".zui-autosuggestion-item").removeClass("highlight"),
z=p=0,a.multiline&&y()):8==d?ka():(P&&"input"==f?L(!0):"keyup"==f&&L(!0),b.trigger("input")))},ia=function(c,f){c.preventDefault();v.find(".zui-autosuggestion-item").removeClass(a.itemhighlightclass);40==f&&p++;38==f&&p--;p>F&&(p=0);0>p&&(p=F);if(0===p){var d=k;l(m,q,k)}else{var g=v.find('.zui-autosuggestion-item[data-highlight="'+p+'"]'),h=g.getData("searchtempdata");g.addClass(a.itemhighlightclass);d=h.text;l(m,"")}e.setValue(d);a.multichoice&&(e.width(K.setInnerHTML(e.getValue("")).width()+10),
n.top(u.height()));h&&a.usedproperty in h?b.setValue(h[a.usedproperty]):("text"==a.usedproperty||a.usedpropertytext)&&b.setValue(k);a.multiline&&y();I.scrollToElement(g);"object"==typeof h&&(b.trigger("ui:autosuggestion:highlight",h),""!=a.itemLinkFormat&&(S=g.getAttr("href")))},ja=function(){if(""!=q&&(e.setValue(k=q),l(m,q=""),0>=p&&(p=z),n.addClass("zui-panel-hide"),!(0>=p))){var c=v.find('.zui-autosuggestion-item[data-highlight="'+p+'"]').getData("searchtempdata");"object"==typeof c&&(a.multichoice?
(e.setValue("").width(10),c&&a.usedproperty in c&&(zjs('<div class="zui-autosuggestion-token"></div>').setInnerHTML(c.text).setAttr("data-value",c[a.usedproperty]).insertBefore(e),h.addClass("zui-autosuggestion-with-token"),A())):(a.multiline&&y(),c&&a.usedproperty in c&&(T=c[a.usedproperty],k=c[a.searchproperty],e.setValue(k),b.setValue(T))),r&&r.setValue(c.id),b.trigger("ui:autosuggestion:choice",c))}},V=function(){k=e.getValue("");var c={text:k},f=!1;if((z||p||!n.hasClass("zui-panel-hide"))&&""!=
k){if(0<p)f=v.find('.zui-autosuggestion-item[data-highlight="'+p+'"]');else if(0<z)f=v.find('.zui-autosuggestion-item[data-highlight="'+z+'"]');else if("id"==a.usedproperty){var d=v.find(".zui-autosuggestion-item");0<d.count()&&(f=d.item(0))}f&&(c=f.getData("searchtempdata"))}""!=k&&l(m,q="");n.addClass("zui-panel-hide");"object"==typeof c&&(a.multichoice?(e.setValue("").width(10),k="",c&&a.usedproperty in c&&(zjs('<div class="zui-autosuggestion-token"></div>').setInnerHTML(c.text).setAttr("data-value",
c[a.usedproperty]).insertBefore(e),h.addClass("zui-autosuggestion-with-token")),A()):c&&(l(m,q=""),n.addClass("zui-panel-hide"),a.searchproperty in c&&e.setValue(k=c[a.searchproperty]),a.usedproperty in c&&b.setValue(c[a.usedproperty])),r&&r.setValue(c.id),b.trigger("ui:autosuggestion:choice",c),""!=a.itemLinkFormat&&f&&(c=f.getAttr("href"),c==S&&(window.location.href=c)))},ka=function(){a.multichoice&&""==e.getValue("")&&(h.find(".zui-autosuggestion-token").lastChild().remove(),A(),""==b.getValue()&&
(h.removeClass("zui-autosuggestion-with-token"),q="",function(){m.top(e.top()).left(e.left()).show();l(m,x())}.delay(80)))},L=function(c){var f=e.getValue("");k=f;l(m,"");""!==f?h.addClass("has-value"):h.removeClass("has-value");if(a.multichoice){e.width(K.setInnerHTML(f).width()+10);if(""==f){""==b.getValue()?l(m.show(),x()):m.hide();q="";l(m,x());n.addClass("zui-panel-hide");return}m.top(e.top()).left(e.left()).show()}else{a.multiline&&y();"text"==a.usedproperty||a.usedpropertytext?b.setValue(f):
b.setValue("");if(""==f&&B){M();return}if(""==f||c&&f.length<a.minlength){q="";""!=f?l(m,"",f):l(m,x());n.addClass("zui-panel-hide");return}}c&&G&&(p=0,q="",z=0,b.trigger("ui:autosuggestion:beforesearch",{value:f}),b.getData("zjsmoduleautosuggestiondictionary").asyncSearch(f,function(c){b.trigger("ui:autosuggestion:searchresult",{value:f,result:c});k=e.getValue();""===k&&l(m,x());if(0===c.length||""===k)n.addClass("zui-panel-hide");else{F=c.length;n.removeClass("zui-panel-hide").top(u.height());v.setInnerHTML("");
var d=0;zjs.eachItem(c,function(c,b){var e=W(a,v,c,b);d+=e.height();e.hover(X);e.click(Y);if(""==q){e=c.text.toLowerCase();var g=f.toLowerCase();0===e.indexOf(g)&&(q=f+c.text.substr(f.length),z=b+1)}});l(m,q,f);R(d)}}))};b.setData("zjsmoduleautosuggestionkeytype",L);var X=function(c){v.find(".zui-autosuggestion-item").removeClass(a.itemhighlightclass);c=zjs(this).addClass(a.itemhighlightclass).getData("searchtempdata");"object"==typeof c&&b.trigger("ui:autosuggestion:highlight",c)},Y=function(c){c=
zjs(this);var f=c.getData("searchtempdata");"object"==typeof f&&(k=f.text,e.setValue(k),h.addClass("has-value"),a.multichoice?(e.setValue("").width(10),f&&a.usedproperty in f&&(zjs('<div class="zui-autosuggestion-token"></div>').setInnerHTML(f.text).setAttr("data-value",f[a.usedproperty]).insertBefore(e),h.addClass("zui-autosuggestion-with-token"),A())):(f&&a.usedproperty in f&&b.setValue(f[a.usedproperty]),a.multiline&&y()),r&&r.setValue(f.id),p=c.getAttr("data-highlight",0).toInt(),l(m,q=""),n.addClass("zui-panel-hide"),
...
function(a,b){D(a,"keydown")}).on("keypress",function(a,b){D(a,"keypress")}).on("keyup",function(a,b){D(a,"keyup")}).on("mouseup",function(a,b){D(a,"keyup")});e.on("blur",function(a){U()});u.on("click",function(){e.focus()});var N=!1;b.on("focus",function(){N||e.focus()});e.on("focus",function(){h.addClass("focus");N=!0;b.trigger("focus");N=!1}).on("blur",function(){h.removeClass("focus");r&&""===e.getValue().trim()&&r.setValue(a.noneValue);b.trigger("blur")}).on("keyup",function(){b.trigger("keyup")});
