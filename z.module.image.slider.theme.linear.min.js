...
to:a,onProcess:function(a){E.left(a)},onFinish:function(a,b){E.left(b)}}).run()}}else T.remove();a.navDot||D.remove();var Ia=function(a){};a.navButton?(a.navButtonParentIsRoot&&f.find(".nav-next, .nav-back").appendTo(f),Ia=function(b){var c=a.navButtonTemplate;g.isFunction(c)&&(c=c(y,d[y]));c=c.format(d[y])+"";b=g(c).addClass("nav-back").setAttr("data-index",y);c=f.find(".nav-back").item(0);b.insertBefore(c).click(function(a){a.preventDefault();g(this).hasClass("disabled")||Ja()});c.remove();c=a.navButtonTemplate;
g.isFunction(c)&&(c=c(u,d[u]));var c=c.format(d[u])+"",c=g(c).addClass("nav-next").setAttr("data-index",u),e=f.find(".nav-next").item(0);c.insertBefore(e).click(function(a){a.preventDefault();g(this).hasClass("disabled")||ta()});e.remove();a.sequent&&(a.navButtonAutoDisable&&(k==d.length-1&&c.addClass("disabled"),0==k&&b.addClass("disabled")),!a.navButtonAutoDisable||0!=u||201!=a.transition&&202!=a.transition&&204!=a.transition&&205!=a.transition||c.addClass("disabled"))}):f.find(".nav-back, .nav-next").remove();
if(a.navThumbSlider){var C=g("<div></div>").appendTo(f).addClass("nav-slider-wrap"),P=g("<div></div>").setInnerHTML(na).appendTo(C);P.addClass("imageslider-linear-navigation").makeSlider({slideitem:a.slideitem,theme:"linear",border:!1,preload:!1,autoplay:!1,navButton:a.navThumbSliderNavButton,navThumb:!1,navDot:!1,showInfo:!1,linkTitle:!1,linkCover:!1,contentSlide:a.contentSlide,usePercentWidth:a.navThumbSliderUsePercentWidth,transition:a.navThumbSliderTransition,transitionTime:a.navThumbSliderTransitionTime,
transitionTimingfunction:a.navThumbSliderTransitionTimingfunction,autoHeight:a.navThumbSliderAutoHeight}).on("slider:click",function(a){t(a.getData().index)});f.on("slider:change",function(a){P.find(".image-hold").removeClass("main-slider-active");var b=P.find(".image-hold.image"+a.getData().index).addClass("main-slider-active"),e=parseInt(P.find(".image-view-wrap").getData("real-pos")),d=P.width(),f=b.left(),b=b.width();(0>e+f||e+f+b>d)&&P.slideTo(a.getData().index)})}a.linkTitle&&ra.hover(function(){f.addClass("linktitlehover")},
...
(r+=m,0>r&&(r=d.length-1),r>=d.length&&(r=0),2<d.length&&h.find(".image"+r).left(h.find(".image"+k).left()+2*l*m));0>p&&!a.sequent&&1<d.length&&h.find(".image"+(d.length-1)).left(-l);e?(da(),v(q,!0),V.delay(100)):F?v(q,!0):va.stop().set({from:z,to:q}).run();break;default:h.find(".image"+k).setStyle("opacity",1).show(),1<d.length&&h.find(".image"+p).setStyle("opacity",0).hide()}a.linkTitle&&""!=J?ra.setInnerHTML('<a href="'+J+'">'+ba+"</a>"):ra.setInnerHTML(ba);a.linkCover&&""!=J&&aa.find("a").setAttr("href",
J);Ma.setInnerHTML(sa);h.find(".image-hold").removeClass("active active-next active-back active-next2 active-back2 out-of-range");M(b,"active");1<d.length&&M(b+1,"active-next");2<d.length&&M(b-1,"active-back");3<d.length&&M(b+2,"active-next2");4<d.length&&M(b-2,"active-back2");f.find(".nav-image, .nav-dot").removeClass("active");f.find(".nav-image[data-index="+b+"], .nav-dot[data-index="+b+"]").addClass("active");a.navThumb&&Oa();g.moduleTransition&&h.find(".image"+k+" ."+a.customTransitionClass).playTransition({autoplay:!1});
...
(b=a,g.isObject(d[k].option)&&(b=g.extend(b,d[k].option)),L.set({time:b.autoplayTime}).run());a.lazyloadImage&&!d[k].lazyloaded&&(d[k].lazyloaded=!0,(b=d[k].lazyEl||d[k].customEl)&&b.eachElement(function(b){b=g(b);g.loadImage({image:d[k].srclazy,onError:function(a){},onLoaded:function(c){(function(){b.removeClass("imageloading");b.is("img")?b.setAttr("src",c.src):b.setStyle("background-image","url("+c.src+")")}).delay(a.lazyloadDelay)}})}))}}else a.autoplay&&L.run();else a.autoplay&&L.run()},Q=function(a){a>=
...
a.autoDisableWhenWidthLargerThan&&!0===x?X():b<a.autoDisableWhenWidthLargerThan&&!1===x&&Y());0<a.autoDisableWhenWindowWidthLessThan&&(c<=a.autoDisableWhenWindowWidthLessThan&&!0===x?X():c>a.autoDisableWhenWindowWidthLessThan&&!1===x&&Y());0<a.autoDisableWhenWindowWidthLargerThan&&(c>=a.autoDisableWhenWindowWidthLargerThan&&!0===x?X():c<a.autoDisableWhenWindowWidthLargerThan&&!1===x&&Y());if(x){if(2==a.transition||203==a.transition)a.sequent||(q=q*b/l),h.find(".image-hold").eachElement(function(c,
e){var d=g(c);a.sequent?d.left(b*e):d.left(d.left()*b/l)}),v(q);l=b;var e=n;0<a.scaleHeightWhenWidthLessThan&&(l<=a.scaleHeightWhenWidthLessThan?(a.fullHeight&&f.removeClass("fullheight"),n=ca*l/a.scaleHeightWhenWidthLessThan):a.fullHeight?(f.addClass("fullheight"),n="",ca=O.height()):n=ca,h.height(n),U.height(n));3==a.transition&&(a.sequent||(q=q*n/e),h.find(".image-hold").eachElement(function(b,c){var d=g(b);a.sequent?d.top(n*c):d.top(d.top()*n/e)}),v(q));2!=a.transition&&203!=a.transition&&3!=
a.transition||t(k,{},!0,!0,!0)}};N.on("resize",function(){ha.delay(500)}).trigger("resize");0<parseInt(g(document.body).getData("zmodulescrollbarid",0))&&ha.delay(500)}a.usePercentWidth&&(C=function(){l=U.width();for(var a=0,c=0;c<d.length;c++){var e=g(d[c].el);e.left(a);a+=e.width()}(function(){t(k,{},!0,!0,!0)}).delay(1)},N.on("resize",C),C.delay(500));var fa=function(){};a.autoHeight&&(fa=function(){if(x){var b=0;if((0==a.transition||1==a.transition||2==a.transition)&&"customEl"in d[k]){var c=
d[k].customEl.height();c>b&&(b=c)}(201==a.transition||202==a.transition||203==a.transition||204==a.transition||205==a.transition)&&a.contentSlide&&g.foreach(d,function(a){"undefined"!=typeof a.customEl&&(a=a.customEl.height(),a>b&&(b=a))});b&&(w.height(b),U.height(b),h.height(b))}},N.on("resize",fa),fa.delay(500));var ia=a.playButton?f.find(".play-wrap"):!1,ja=a.playButton?f.find(".play-process-bar"):!1,L=g.timer({time:a.autoplayTime,transition:"linear",onProcess:function(a){ja&&ja.height(a+"%")},
onStop:function(){ja&&ja.height("0%")},onFinish:function(){ta()}}),ka=function(){a.autoplay=!0;L.stop().run();ia&&ia.addClass("pause")},Aa=function(){a.autoplay=!1;L.stop();ia&&ia.removeClass("pause")};a.playButton&&f.find(".play-wrap").click(function(b){b.preventDefault();a.autoplay?Aa():ka()});a.navDot||a.navThumb||a.navButton&&!a.navButtonParentIsRoot||f.find(".nav-wrap").remove();a.playButton||f.find(".play-wrap").remove();a.border||f.find(".image-view-border").remove();!a.contentSlide&&a.showInfo||
f.find(".image-info-wrap").remove();(202==a.transition&&a.navDot||204==a.transition||205==a.transition)&&N.on("resize",function(){var b=parseInt(w.width()/l);202!=a.transition&&205!=a.transition||!a.navDot||Ea.find(".nav-dot").eachElement(function(a,c){0==c%b?g(a).show():g(a).hide()});if(204==a.transition||205==a.transition){var c=(w.width()-b*l)/2;ua=2*c;w.setStyle({paddingLeft:c,paddingRight:c})}}).trigger("resize");var la=!1,ma=!1,Z=function(b){if(a.popup){try{if(b=0!==b?b||-1:0,0>b||b>=d.length)b=
k}catch(A){b=k}var c=g('<div class="imageslider-popup-page-cover"></div>').appendTo(document.body);c.addClass(a.popupPageCoverClass);var e=g('<div class="imageslider-popup-container"><a class="imageslider-popup-close-button">&times;<i class="icon"></i></a><div class="imageslider-popup-wrap"><div class="inpopup-imageslider"></div></div></div>').appendTo(document.body),h=e.find(".imageslider-popup-close-button"),l=e.find(".inpopup-imageslider");e.addClass(a.popupContainerClass);R.addClass("imageslider-popup-show");
a.popupAllowKeyboard&&l.addClass("allow-keyboard");f.setData("popupsliderels_popupPageCoverEl",c);f.setData("popupsliderels_popupContainerEl",e);f.setData("popupsliderels_inpopupSliderEl",l);l.setData("parent_SliderEl",f);c.fadeIn({time:a.popupAnimateTime});a.popupAnimate&&e.addClass("zui-popup hide-before-animate "+a.popupAnimateName).setStyle("animation-duration",a.animateTime+"ms");l.on("slider:ready",function(){Aa();a.popupAnimate?(e.removeClass("hide-before-animate"),window.clearTimeout(la),
window.clearTimeout(ma),e.addClass("showing animate animate-start"),la=function(){e.addClass("animate-end")}.delay(a.popupAnimateTime),ma=function(){e.removeClass("showing animate animate-start animate-end")}.delay(a.popupAnimateTime+100)):e.fadeIn();f.trigger("slider:popup:show",{index:b,info:d[b]})});var m=g.extend(g.clone(a),{popup:!1,popupOnly:!1,popupShowOnClick:!1,popupHideOnClickOut:!1,popupCloseButton:!1,startIndex:b,autoplay:a.popupAutoplay,autoplayTime:a.popupAutoplayTime,playButton:a.popupPlayButton,
navButton:a.popupNavButton,navButtonParentIsRoot:a.popupNavButtonParentIsRoot,navThumb:a.popupNavThumb,navDot:a.popupNavDot,linkTitle:a.popupLinkTitle,linkCover:a.popupLinkCover,sequent:a.popupSequent,fullWidth:a.popupFullWidth,fullscreenWidth:a.popupFullscreenWidth});!1!==m.popupTransition&&(m.transition=m.popupTransition);!1!==m.popupTransitionTime&&(m.transitionTime=m.popupTransitionTime);!1!==m.popupTransitionTimingfunction&&(m.transitionTimingfunction=m.popupTransitionTimingfunction);(function(){l.setInnerHTML(na);
l.setData("zmodulesliderlinearispopup",!0).makeSlider(m)}).delay(100);a.popupHideOnClickOut&&c.click(function(a){a.preventDefault();Ba()});a.popupCloseButton?h.click(function(a){a.preventDefault();Ba()}):h.remove()}},C=function(b){var c=!1;if(ya)ya=!1;else{!g(b.target()).is("a[href]")&&0>=g(b.target()).findUp("a[href]").count()&&!g(b.target()).is("input,textarea,label")&&!g(b.target()).is("textarea")&&(b.preventDefault(),c=!0);var d=-1;(b=b.target())&&(b=g(b));b.hasClass("image-hold")||(b=b.findUp(".image-hold"));
b.hasClass("image-hold")||(b=!1);b&&(d=parseInt(b.getData("image-index",-1)));0<=d?(a.popup&&a.popupShowOnClick&&Z(d),f.trigger("slider:click",{index:d},function(b){203==a.transition&&c&&!b.isDefaultPrevented&&t(d)})):a.popup&&a.popupShowOnClick&&Z()}};h.click(C);aa.click(C);var Ba=function(){if(a.popup){var b=f.getData("popupsliderels_popupPageCoverEl"),c=f.getData("popupsliderels_popupContainerEl"),d=f.getData("popupsliderels_inpopupSliderEl");d&&d.slidePause();c&&(a.popupAnimate?(window.clearTimeout(la),
window.clearTimeout(ma),c.addClass("hiding animate animate-start"),la=function(){c.addClass("animate-end")}.delay(a.popupAnimateTime),ma=function(){c.removeClass("hiding animate animate-start animate-end");c.remove()}.delay(a.popupAnimateTime+100)):c.removeSlow());b&&b.fadeOut({time:a.popupAnimateTime,callback:function(){b.remove();R.removeClass("imageslider-popup-show")}});f.trigger("slider:popup:hide")}};f.trigger("slider.ready");var Ca=!1;"function"==typeof g.loadImages&&(a.preload&&(Ca=g('<div class="slider-loading-wrap"><div class="text-wrap"><span class="percent"></span>%</div></div>').appendTo(B)),
g.loadImages({images:function(){for(var a=[],c=0;c<d.length;c++)"undefined"!=typeof d[c].src&&""!=d[c].src&&a.push(d[c].src),"undefined"!=typeof d[c].srclarge&&""!=d[c].srclarge&&a.push(d[c].srclarge),"undefined"!=typeof d[c].srcpopup&&""!=d[c].srcpopup&&a.push(d[c].srcpopup);return a}(),onLoading:function(b){a.preload&&Ca.find(".percent").setInnerHTML(b.toString())},onFinish:function(){if(a.preload&&(!a.debug||"loading"!=a.debug)){Ca.removeSlow();t(0,{},!0,!0);1<d.length&&(t(1,{direction:"next"},
!0,!0),t(0,{direction:"prev"},!0,!0));if(0<a.startIndex)for(var b=0;b<a.startIndex;)t(++b,{direction:"next"},!0,!0);(a.fullscreenWidth||a.fullWidth)&&ha();a.autoplay&&ka();f.trigger("slider:load");za()}}}));if(!a.preload){t(0,{},!0,!0);1<d.length&&(t(1,{direction:"next"},!0,!0),t(0,{direction:"prev"},!0,!0));if(0<a.startIndex)for(B=0;B<a.startIndex;)t(++B,{direction:"next"},!0,!0);(a.fullscreenWidth||a.fullWidth)&&ha();a.autoplay&&ka();f.trigger("slider:load");za()}return{slideTo:t,slideNext:ta,slidePrev:Ja,
slidePlay:ka,slidePause:Aa,slidePopupShow:Z,slidePopupHide:Ba,slideRefresh:za,slideDisable:function(){X(!0)},slideEnable:function(){Y(!0)}}});g(document).on("keydown",function(B){if(37==B.keyCode()||39==B.keyCode()||27==B.keyCode()){var d=g(".inpopup-imageslider.allow-keyboard");0>=d.count()||(37==B.keyCode()&&d.slidePrev(),39==B.keyCode()&&d.slideNext(),27==B.keyCode()&&d.getData("parent_SliderEl").slidePopupHide())}});"required"in g&&g.required("image.slider.theme.linear")});