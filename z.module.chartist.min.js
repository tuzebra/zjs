(function(a){var k=0;a.extendCore({moduleChartistOption:{type:'line',fullWidth:!0},moduleChartistPlugins:{}});a.extendMethod({makeChartist:function(c){return this.each(function(h){var d=a(h),b=d.getData("zmodulechartistoption");if(b)d.setData("zmodulechartistoption",a.extend(b,c));else{var b=a.clone(a.moduleChartistOption),e=d.getAttr("data-option","");a.isString(e)&&""!=e.trim()&&(b=a.extend(b,e.jsonDecode()));d.removeAttr("data-option");"undefined"!=typeof c&&(b=a.extend(b,c));d.setData("zmodulechartistoption",
b);e=d.getInnerHTML().trim().jsonDecode();d.html("");d.setData("zmodulechartistdata",e);var f=d.getAttr("id","");""==f&&(f="zchartist"+k++,d.setAttr("id",f));var f=b,g="";"type"in b&&"line"==b.type.toLowerCase()&&(g="Line");"type"in b&&"bar"==b.type.toLowerCase()&&(g="Bar");"type"in b&&"pie"==b.type.toLowerCase()&&(g="Pie");""!=g&&(h=new Chartist[g](h,e,f),d.setData("zmodulechartobj",h))}})},makeChartist__:function(){return this.each(function(c){a(c).getData("zmodulechartobj")})}});a.hook({after_setInnerHTML:function(c){a(c).find(".zchartist").makeChartist()},
after_insertDOM:function(c){a(c).hasClass("zchartist")&&a(c).makeChartist();a(c).find(".zchartist").makeChartist()}});a.onready(function(){a(".zchartist").makeChartist()});"required"in a&&a.required("chartist")})(zjs);
