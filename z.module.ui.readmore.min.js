...
padding:b.getStyle("padding"),font:b.getStyle("font"),border:b.getStyle("border"),"box-sizing":b.getStyle("box-sizing")});a.enablehook(n);var q=!1,r=function(d){q||(d=d||!1,a.enablehook(!1),k.width(b.parent().width()),u("needed",c,l,p)?(d=u("gettrimtext",c,l,p,{readmoreText:t}),f.appendTo(h),b.setInnerHTML(d),b.append(f)):(f.appendTo(h),b.setInnerHTML(l),d&&(f.remove(),k.remove(),q=!0)),a.enablehook(n))};a(window).on("resize",function(){r()});b.on("ui:readmore:trigger_refresh",function(){r()});r(!0);
if(f.count())f.on("click",function(d){d.preventDefault();a.enablehook(!1);f.remove();q=!0;b.setInnerHTML(l);k.remove();a.enablehook(n)})}},m={"max-height":function(a,e,b,c,g){if("needed"==a)return c.setInnerHTML(b),c.height()>e.max;if("gettrimtext"==a){b=b.split(" ");b.push(" ");do b.pop(),c.setInnerHTML(b.join(" ")),a=c.getInnerHTML()+e.ellipsis+" ",c.setInnerHTML(a+g.readmoreText);while(b.length&&c.height()>e.max);return a}},"max-line":function(a,e,b,c,g){if("needed"==a||"gettrimtext"==a){var d=
