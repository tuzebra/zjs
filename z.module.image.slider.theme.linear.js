...
// 		console.log('zImageViewContainer', zImageViewContainer.item(0, true));
		...
		if(option.navButton){
			...
			doTriggerChangeNavButton = function(moreparam){
				...
				//console.log('doTriggerChangeNavButton', moreparam);
				//console.log('images', images);
				//console.log('estimatePrevIndex', estimatePrevIndex);
				// console.log(images[estimatePrevIndex]);
				//console.log(images[estimateNextIndex]);
				...
				// console.log(option.transition, estimateNextIndex);
				...
				// console.log(currentIndex, images.length, option.transition, option.sequent);
			};
		...
		var showLargeImage = function(index, moreparam, notTransition, notTriggerEvent, isInnerCall){
			...
			if(option.transition == 202 || option.transition == 205){
				...
				estimatePrevIndex = currentIndex - _imagePerPage;
				estimateNextIndex = currentIndex + _imagePerPage;
