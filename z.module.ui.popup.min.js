...
d.child().eachElement(function(a){h.append(a)});d.append(h);zjs.enablehook(e);e=d.find(".zpopupclose");0==e.count()&&a.closebutton&&(e=zjs('<a class="zui-popup-close">\u00d7</a>').prependTo(d));e.click(function(a,c){zjs(this).hasClass("disabled")||k(b)});a.autoshow?r(b):(d.addClass("active"),k(b,!0,!0));d.removeClass("zui-uiuninithide zui-uiuninithideh zpopupuninithide zpopupuninithideh");zjs(window).on("resize",function(){l(b)}).on("scroll",function(){l(b)})}},m=!1,n=!1,r=function(b){var c=zjs(b),
d=c.getData("zmoduleuipopupoption");if(d&&!c.hasClass("active")){c.getData("zmoduleuipopupcoverel").insertBefore(c).setStyle("z-index",p());c.removeClass("zui-popup-hide").setStyle("z-index",p());var a=!!zjs(document.body).getData("zmodulescrollbaroption",!1),e=a?zjs(document.body).scrollPosition():document.body.scrollTop;c.setData("zmoduleuipopupscrolltop",e);if(q(d.longPopup)){c.addClass("zui-long-popup");var f=zjs("<div></div>"),g=a?zjs(document.body).getData("zmodulescrollbarcontentel",!1):zjs(document.body);
g&&(g.child().eachElement(function(a){"SCRIPT"==a.tagName||"LINK"==a.tagName||zjs(a).hasClass("zui-popup")||zjs(a).hasClass("zui-popup-page-cover")||zjs(a).hasClass("zpreventlongpopup")||"fb-root"==zjs(a).getAttr("id")||f.append(a)}),zjs(document.body).prepend(f),f.setStyle({position:"fixed",width:"100%",height:"100%"}),f.top(-e),a?zjs(document.body).refreshScroll().scrollTo(0,!0):document.body.scrollTop=0,c.setData("zmoduleuipopupfixedbodyel",f),zjs(document.body).addClass("zui-long-popup-is-open"));
