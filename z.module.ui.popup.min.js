...
(F(),A.push(p));a.pullDown&&a.longPopup&&zjs.isMobileDevice()&&(G(),C.push(p));(function(){c.find(".autofocus").focus();a.disableWindowScroll&&"disableScroll"in l&&("mobileOnly"===a.disableWindowScroll?zjs.isMobileDevice()&&l.disableScroll():l.disableScroll());d&&zjs.isFunction(d.callback)&&d.callback.call(c,b);c.trigger("ui:popup:aftershow")}).delay(h+100)}},r=function(b,d,c){var a=zjs(b),e=a.getData("zmoduleuipopupoption");if(e&&a.hasClass("active")&&!a.hasClass("zui-popup-hide")){a.trigger("ui:popup:beforehide");
e.disableWindowScroll&&"enableScroll"in l&&("mobileOnly"===e.disableWindowScroll?zjs.isMobileDevice()&&l.enableScroll():l.enableScroll());var f=function(){a.addClass("zui-popup-hide");a.removeClass("active").trigger("ui:popup:hide");var b=a.getData("zmoduleuipopupfixedbodyel",!1);if(b){var d=!!zjs(document.body).getData("zmodulescrollbaroption",!1),f=a.getData("zmoduleuipopupscrolltop",0);n.length&&n.pop();0===n.length?(a.setData("zmoduleuipopupfixedbodyel",!1),d&&zjs(document.body).getData("zmodulescrollbarcontentel",
!1).prepend(b),b.child().eachElement(function(a){zjs(a).insertBefore(m)}),b.remove(),m.remove(),d?zjs(document.body).refreshScroll().scrollTo(f,!0):zjs(document.body).setStyle("scrollTop",f),zjs(document.body).removeClass("zui-long-popup-is-open"),d=a.getData("zlongpopuplistelswap",[]),0<d.length&&d.eachItem(function(a){var b=zjs(a).getData("zlongpopupswapel",!1);b&&zjs(a).insertBefore(b);b.remove();zjs(a).hasClass("zui-freezing")&&zjs(a).freezepanelDisableHandler(!1)})):(b=zjs('.zui-long-popup[data-show-instance="'+
n.last()+'"]'),zjs(document.body).append(b.getData("zmoduleuipopupcoverel")),zjs(document.body).append(b),a.getData("zmoduleuipopupfixedbodyel").remove(),zjs(document.body).setStyle("scrollTop",0),d||zjs(document.body).setStyle("scrollTop",f))}!c&&e.closethenremove&&(!1!==e.scrollPopup?a.getData("zmoduleuipopupscrollwrapel").remove():a.remove())};b=function(){if(a){var b=a.getData("zmoduleuipopupcoverel");b&&b.remove(!1);!1!==e.scrollPopup&&(a.getData("zmoduleuipopupscrollwrapel").hide(),0<q&&q--,
0===q&&zjs(document.body).removeClass("zui-scroll-popup-is-open").setStyle("padding-right",""))}};d=d||!1;!d&&e.fadeCover?a.getData("zmoduleuipopupcoverel").fadeOut({time:e.fadeTime,callback:b}):b();d||!e.fade||e.animate?!d&&e.animate?(window.clearTimeout(u),window.clearTimeout(v),a.addClass("hiding zanimate zanimate-start"),u=function(){a.addClass("zanimate-end")}.delay(e.animateTime),v=function(){a.removeClass("hiding zanimate zanimate-start zanimate-end");f()}.delay(e.animateTime+100)):f():a.fadeOut({time:e.fadeTime,
callback:f});a.removeAttr("data-show-instance")}},E=function(b){var d=zjs(b);d.getData("zmoduleuipopupoption")&&!d.hasClass("zui-popup-hide")&&(d.hasClass("zui-popup-center")&&t(b),d.trigger("ui:popup:refresh"))},t=function(b){var d=zjs(b),c=d.getData("zmoduleuipopupoption");if(c&&d.hasClass("zui-popup-center"))if(b=l.height()-d.height(),c.longPopup||c.scrollPopup)0<b?d.setStyle("margin-top",b/2):d.setStyle("margin-top",""),function(){d.find(".zfreezepanel").trigger("trigger:refreshpanel")}.delay(100);
else{if(0<b){var a=-d.height()/2;c.centerY||(a-=b/6)}else c=d.getData("zmoduleuipopupscrolltop")-document.body.scrollTop,c<b&&(c=b),0<c&&(c=0),a=-d.height()/2-b/2+c;d.setStyle("margin-top",a);d.setStyle("margin-left",-d.width()/2)}},I=function(){var b=zjs('<div style="width:50px;height:50px;overflow:hidden;position:absolute;top:-200px;left:-200px;"><div style="height:100px;"></div>');zjs(document.body).append(b);var d=b.item(0,!0).offsetWidth;b.setStyle("overflow","scroll");var c=b.item(0,!0).clientWidth;
b.remove();return d-c},y=!1,B=!1;zjs.extendMethod({makePopup:function(b){return this.eachElement(function(d){H(d,b)})},popupShow:function(b){return this.eachElement(function(d){D(d,b)})},popupHide:function(){return this.eachElement(function(b){r(b)})},popupRefresh:function(){return this.eachElement(function(b){E(b)})},popupBackdrop:function(){return this.getData("zmoduleuipopupcoverel")}});zjs.hook({after_setInnerHTML:function(b){zjs(b).find(".zpopup").makePopup();zjs(b).parent().popupRefresh().parent().popupRefresh().parent().popupRefresh()},
