...
zjs(b),c=d.getData("zmoduleuiaccordionoption");if(c&&c.useurlhash){var c=!1,a=d.find('[data-name="'+document.location.hash.substr(1)+'"]');0>=a.count()&&(a=d.find("#"+document.location.hash.substr(1)));0<a.count()&&(d=parseInt(a.getData("zmoduleuiaccordiontitleindex",-1)),0<=d&&(f(b,d,!0),c=!0));return c}}},f=function(b,d,c,a){a=a||!1;var g=zjs(b),e=g.getData("zmoduleuiaccordionoption");if(e){var f=g.find(">.zui-accordion-wrap").item(d);if(f.hasClass("active")){if(e.allowclose){var l=f.find(">.zui-accordion-title"),
